...
phi0phi0path = joinpath(dircfile, "phi0phi0.bdio")
phi0phi0Q0path = joinpath(dircfile, "phi0phi0-Q0.bdio")
phi0phi0Q1path = joinpath(dircfile, "phi0phi0-Q1.bdio")
...
uwphi0phi0c = global_phitphi0(0, ens, cfile, sector=nothing)
uwphi0phi0cQ0 = global_phitphi0(0, ens, cfile, sector=0)
uwphi0phi0cQ1 = global_phitphi0(0, ens, cfile, sector=1)
...
write(phi0phi0path, uwphi0phi0c)
write(phi0phi0Q0path, uwphi0phi0cQ0)
write(phi0phi0Q1path, uwphi0phi0cQ1)
